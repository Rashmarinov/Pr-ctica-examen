...
public class PracticaController {
    ...
    public String updateCliente (Model model, @RequestParam long idCliente){
        ...
        Optional<TablaClientes> tablaClientes = clienteRepository.findById(idCliente);
        if (tablaClientes.isPresent()) {
            model.addAttribute("tablaClientes",tablaClientes.get() );
            model.addAttribute("tablaFacturas",tablaClientes.get().getTablaFacturas() );
        }     
